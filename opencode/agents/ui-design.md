...
2. Responde con este molde:
   ...
   > `<lo pedido>`. **Sal del modo UI Design** y usa: **@data-api**
   > (datos/APIs), **@architecture** (arquitectura), **@security**
   > (seguridad/cifrado), **@code-quality** (calidad), **@git-release-manager** (commits/push/releases), **@sdd** (features/negocio) o el agente
   > general.
