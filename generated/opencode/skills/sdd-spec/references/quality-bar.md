...
8. **Tests mínimos:** lógica pura obligatoria; ≥1 camino de error con fake/mock si hay puertos/protocols.
9. **PBT:** solo si hay invariante algebraico y el modo lo permite (ver `testing.md`).
10. **Proporcionalidad design (`standard`):** techo orientativo ~200–250 líneas; 1 flowchart + 1 sequence; C4/ER solo en `deep` o si hay BD interna real.
