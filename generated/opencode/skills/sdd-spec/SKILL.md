...
> El gate se
> implementa de forma natural: Termina tu turno con la pregunta y espera. Excepción: Quick Plan.

### Fase 1 — Requirements

1. Lee steering (`AGENTS.md`, `.sdd/steering/*.md`). Detecta dominio y lee
