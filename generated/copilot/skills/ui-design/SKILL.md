...
revisiones incrementales. Para extracción completa, rediseños de
...
Recomienda continuar con `SDD (Spec-Driven Development)` ante requisitos o criterios de aceptación
...
las ubicaciones disponibles, ofrece una instrucción copiable para `SDD (Spec-Driven Development)`
