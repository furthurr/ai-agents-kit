...
especificaciones de alta calidad y trazables. Complementa al agente SDD (Spec-Driven Development) y funciona con cualquier agente de GitHub Copilot.
...
> `SDD (Spec-Driven Development)` y esta skill divergen, **manda esta skill**.
...
### Fase 1 — Requirements
1. Lee el steering si existe (`.github/copilot-instructions.md`, `AGENTS.md`, `.sdd/steering/*.md`). Detecta
