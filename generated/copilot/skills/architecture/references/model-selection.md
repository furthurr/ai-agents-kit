...
| --- | --- | --- |
| Consulta, ADR o ajuste puntual localizado | `BAJO` | No |
| Sincronizacion incremental o documentacion de un modulo | `MEDIO` | No |
...
`continua` o `continua con el actual`. No repitas el aviso por bloque. Si cambia
