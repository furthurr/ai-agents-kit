...
especificaciones de alta calidad y trazables. Complementa al agente sdd y funciona con cualquier agente de Kiro.
...
1. **Lanza el flujo.** Selecciona el agente `sdd` en el selector de agentes o escribe `/sdd-spec` en el chat y describe
...
### Fase 1 — Requirements
1. Lee el steering si existe (`.kiro/steering/*.md`, `AGENTS.md`, `.sdd/steering/*.md`). Detecta
