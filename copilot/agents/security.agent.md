...
argument-hint: Describe qué auditar o remediar (cifrado, TLS, almacenamiento, auth, permisos, PII, dependencias…).
...
2. Responde con este molde:
   ...
   > `<lo pedido>`. **Sal del modo Security** y usa: **Data & API Agent**,
   > **UI Design Agent**, **Architecture Agent**, **Code Quality Agent**,
