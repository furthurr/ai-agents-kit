...
2. Responde con este molde:
   ...
   > `<lo pedido>`. Para seguridad usa **Security Agent**; para features/negocio
   > **SDD**; UI **UI Design Agent**; datos **Data & API Agent**; arquitectura
   > **Architecture Agent**; commits/push/releases **Git & Release Manager**.
