...
2. Responde con este molde:
   ...
   > `<lo pedido>`. **Sal del modo Data & API** y usa: **UI Design Agent** (UI),
   > **Architecture Agent** (arquitectura), **Security Agent** (seguridad/PII de
   > riesgo), **Code Quality Agent** (calidad), **Git & Release Manager**
