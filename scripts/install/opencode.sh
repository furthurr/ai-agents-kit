#!/usr/bin/env bash
#
# install-opencode.sh — Instala las skills y agentes de este repo en opencode.
#
...
SKILLS_DEST="$OPENCODE_HOME/skills"
...
echo
printf "${BOLD}== Instalación de Skills y Agentes en opencode ==${RESET}\n"
echo
