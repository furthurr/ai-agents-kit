...
Recomienda continuar con `{{sdd_agent}}` ante requisitos o criterios de aceptación
...
las ubicaciones disponibles, ofrece una instrucción copiable para `{{sdd_agent}}`
